  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        ...
        <el-form-item>
          <el-button type="primary" v-on:click="getOwners">查询</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <!--列表-->
    <el-table :data="owners" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;" border>
      ...
      <el-table-column prop="Code" label="自定义编码" width="180" sortable>
      </el-table-column>
      <el-table-column label="名称" width="180" sortable prop="Name">
      </el-table-column>
      <el-table-column prop="Contacts" label="联系人" width="180" sortable>
      </el-table-column>
    ...
    <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
      <el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
        ...
        <el-form-item label="联系人">
          ...
          <el-input v-model="editForm.Contacts" style="width:215px"></el-input>
        </el-form-item>
...
<script>
  ...
  import { getOwnerList, ownerSave, addUser, ownerSetStatus } from '../../api/api';
  let qs = require('qs');
  export default {
    data() {
      return {
