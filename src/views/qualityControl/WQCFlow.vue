<template>
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters" class="mini-size" size="mini">
        <el-form-item>
...
<script>
  ...
  import { getWQCFlow, WPSkuSearch, getWarehouseList, getOwnerListTree,SpuSearch} from '../../api/api';
  let qs = require('qs');
  export default {
    data() {
      return {
